...
#define VOLTAGE_DIV_R1       (68.0f)
#define VOLTAGE_DIV_R2       (33.0f)
...
int main()
{
    ...
    while (1) {
		...
		pc.printf("%1.3f\t%d\t%4.1f fps\t%5.2f V\r\n", masterAmplitude, displayMode, count/elapseTime, powerVoltage);
#endif
